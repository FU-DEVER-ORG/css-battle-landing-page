          ...
          <div className={styles['contact-section1']}>
            <div className={styles['contact-section-list']}>
              ...
              <div className={styles['contact-section__round']}>
                <div className={styles['contact-section__rounds']}>
                  <li>
                    45 tuyển thủ tham gia chia thành 9 bảng đấu, mỗi bảng 5
                    tuyển thủ.
                  </li>
                </div>
                <div className={styles['contact-section__rounds']}>
                  <li>
                    Các tuyển thủ thi đấu cá nhân theo bảng và chọn ra 9 tuyển
                    thủ xuất sắc nhất tiến tiếp vào vòng bán kết.
                  </li>
                </div>
                <div className={styles['contact-section__rounds']}>
                  <li>
            ...
            <div className={styles['contact-section-list']}>
              ...
              <div className={styles['contact-section__round']}>
                <div className={styles['contact-section__rounds']}>
                  <li>
                    {' '}
                    9 tuyển thủ xuất sắc từ vòng loại sẽ tiếp tục hành trình vào
                    vòng bán kết, chia thành 3 bảng đấu, mỗi bảng gồm 3 tuyển
                    thủ.
                  </li>
                </div>
                <div className={styles['contact-section__rounds']}>
            ...
            <div className={styles['contact-section-list']}>
              ...
              <div className={styles['contact-section__round']}>
                ...
                <div className={styles['contact-section__rounds']}>
                  <li>
                    Mỗi bộ đề thi đấu sẽ bao gồm 3 câu hỏi, bao gồm 1 câu dễ, 1
                    câu vừa và 1 câu khó.
                  </li>
                </div>
              </div>
            </div>
